...
--[[DGDGDGDG
	...
	if kind == "general" then
		...
		self:drawString(self.font, (player.descriptor and "Class: " or "Stype: ")..((player.descriptor and player.descriptor.subclass) or player.subtype:capitalize())..class_evo, w, h, 0, 200, 255, true)
