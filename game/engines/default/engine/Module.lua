...
function _M:loadScreen(mod)
	...
	local function swap_ui(ui)
		if fs.exists("/data/gfx/"..ui.."/waiter/left.png") and fs.exists("/data/gfx/"..ui.."/waiter/right.png") and fs.exists("/data/gfx/"..ui.."/waiter/middle.png") and fs.exists("/data/gfx/"..ui.."/waiter/bar.png") then
			left = core.display.loadImage("/data/gfx/"..ui.."/waiter/left.png")
			right = core.display.loadImage("/data/gfx/"..ui.."/waiter/right.png")
			middle = core.display.loadImage("/data/gfx/"..ui.."/waiter/middle.png")
			bar = core.display.loadImage("/data/gfx/"..ui.."/waiter/bar.png")
		end
	end
...
function _M:instanciate(mod, name, new_game, no_reboot, extra_module_info)
	...
	UIBase:loadTileset("/data/gfx/ts-ui-all.lua")
