...
--end
if not config.settings.tome.smooth_move then config.settings.tome.smooth_move = 5 end
...
if type(config.settings.tome.actors_seethrough) == "nil" then config.settings.tome.actors_seethrough = false end
