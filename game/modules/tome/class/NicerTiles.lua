...
molten_lava = { method="borders", type="molten_lava", forbid={grass=true, jungle_grass=true, sand=true, lava=true, ice=true},
	default8={add_mos_shader="lava", z=5, add_mos={{image="terrain/lava/molten_lava_2_%02d.png", display_y=-1}}, min=1, max=2},
	default2={add_mos_shader="lava", z=5, add_mos={{image="terrain/lava/molten_lava_8_%02d.png", display_y=1}}, min=1, max=2},
	default4={add_mos_shader="lava", z=5, add_mos={{image="terrain/lava/molten_lava_6_%02d.png", display_x=-1}}, min=1, max=2},
	default6={add_mos_shader="lava", z=5, add_mos={{image="terrain/lava/molten_lava_4_%02d.png", display_x=1}}, min=1, max=2},

	default1={add_mos_shader="lava", z=5, add_mos={{image="terrain/lava/molten_lava_9_%02d.png", display_x=-1, display_y=1}}, min=1, max=2},
	default3={add_mos_shader="lava", z=5, add_mos={{image="terrain/lava/molten_lava_7_%02d.png", display_x=1, display_y=1}}, min=1, max=2},
	default7={add_mos_shader="lava", z=5, add_mos={{image="terrain/lava/molten_lava_3_%02d.png", display_x=-1, display_y=-1}}, min=1, max=3},
	default9={add_mos_shader="lava", z=5, add_mos={{image="terrain/lava/molten_lava_1_%02d.png", display_x=1, display_y=-1}}, min=1, max=2},

	default1i={add_mos_shader="lava", z=5, add_mos={{image="terrain/lava/molten_lava_inner_1_%02d.png", display_x=-1, display_y=1}}, min=1, max=2},
	default3i={add_mos_shader="lava", z=5, add_mos={{image="terrain/lava/molten_lava_inner_3_%02d.png", display_x=1, display_y=1}}, min=1, max=2},
	default7i={add_mos_shader="lava", z=5, add_mos={{image="terrain/lava/molten_lava_inner_7_%02d.png", display_x=-1, display_y=-1}}, min=1, max=2},
	default9i={add_mos_shader="lava", z=5, add_mos={{image="terrain/lava/molten_lava_inner_9_%02d.png", display_x=1, display_y=-1}}, min=1, max=2},
},
