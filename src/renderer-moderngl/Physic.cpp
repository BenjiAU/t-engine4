...
public:
	...
	virtual void DrawPolygon(const b2Vec2* vertices, int32 vertexCount, const b2Color& color) {
		for (int32 i = 1; i <= vertexCount; i++) {
			...
			auto dl = getDisplayList(this, (GLuint)gl_tex_white, NULL, VERTEX_MAP_INFO, RenderKind::LINES);
	...
	virtual void DrawSolidPolygon(const b2Vec2* vertices, int32 vertexCount, const b2Color& color) {
		for (int32 i = 1; i < vertexCount - 1; ++i)
		{
			...
			auto dl = getDisplayList(this, (GLuint)gl_tex_white, NULL, VERTEX_MAP_INFO, RenderKind::TRIANGLES);
	...
	virtual void DrawSolidCircle(const b2Vec2& _center, float32 radius, const b2Vec2& axis, const b2Color& color) {
		...
		r1.Set(1.0f, 0.0f);
		v1 = center + radius * r1;
		dl = getDisplayList(this, (GLuint)gl_tex_white, NULL, VERTEX_MAP_INFO, RenderKind::LINES);
		for (int32 i = 0; i < k_segments; ++i)
		{
			// Perform rotation to avoid additional trigonometry.
			b2Vec2 r2;
	...
	virtual void DrawPoint(const b2Vec2& p, float32 size, const b2Color& color) {
		...
		auto dl = getDisplayList(this, (GLuint)gl_tex_white, NULL, VERTEX_MAP_INFO, RenderKind::POINTS);
