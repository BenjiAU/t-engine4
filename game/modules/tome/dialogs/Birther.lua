...
function _M:init(title, actor, order, at_end, quickbirth, w, h)
	...
	self.actor_frame = ActorFrame.new{actor=self.actor, w=128, h=128}
...
function _M:customizeOptions(cosmetic_actor, on_exit, title)
	...
	local actor_frame = ActorFrame.new{actor=cosmetic_actor, w=128, h=128}
